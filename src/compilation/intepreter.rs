        ...
        Statement::So { name, datatype, initializer } => {
            let value = match initializer {
                ...
                None => match datatype {
                    ...
                    Datatype::Verb(_verb) => Evaluation::Void, // TODO: Implement anonymous default verb
                    Datatype::Adjective(_name) => Evaluation::Void, // TODO: Implement anonymous default adjective
                },
            };
            Ok(VariableValue {
